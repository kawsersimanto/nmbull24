...
const Page = () => {
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8">
      <h2 className="text-[#263238] font-sans text-[30px] sm:text-[40px] md:text-[50px] text-center font-bold mt-[80px] sm:mt-[200px] md:mt-[200px]">
        Help &amp; Support
      </h2>

      <h2 className="font-sans font-bold text-2xl mt-10 sm:mt-20 md:mt-20">
        Privacy Policy
      </h2>
