...
export const HomeComuntiy = () => {
  return (
    <div className="container mx-auto py-12 lg:mt-[300px] mt-[100px]">
          ...
          <div key={index} className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center justify-center">
            ...
            <div className="flex flex-col gap-4 text-center lg:text-left">
              <div className="space-y-2">
                <div className="w-12 h-2 bg-[#0872BA] mx-auto lg:mx-0" />
                <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-5xl text-[#1a2b49]">
                  {data.title}
                </h1>
              </div>
