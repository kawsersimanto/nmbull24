  ...
  return (
    <div className="relative mt-4 lg:mt-[55px]">
      ...
      <div
        ...
        } fixed inset-y-0 left-0 z-[1000] w-[354px] bg-white shadow-lg transition-transform duration-300 ease-in-out overflow-y-auto lg:translate-x-0 pb-8 lg:static lg:w-auto lg:shadow-none lg:rounded-2xl lg:px-3 lg:py-6 lg:max-w-[354px]`}
      >
        <button
