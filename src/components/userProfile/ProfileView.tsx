...
import { useAllUserQuery, useGetUserQuery } from "@/redux/Api/userApi";
...
export const ProfileView = () => {
    ...
    console.log("ldsfkjsaL",currentUser);



    const [avatarSrc, setAvatarSrc] = useState(
         currentUser?.profileImage || "https://i.ibb.co.com/nskVT9Z/348s.jpg"
    );
    ...
    if (userLoading || userLoading) return <div>Loading...</div>;
    if (userError || userError) return <div>Error loading user data.</div>;
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center w-full md:w-auto">
                    ...
                    <div className="text-center md:text-left">
                        <h1 className="text-xl md:text-2xl lg:text-[32px] text-[#263238] font-sans font-bold">
                            {currentUser?.firstName} {currentUser?.lastName||"Na"}
                        </h1>
